...
The above task assumes its port is "59001". If you wish to use another parameter please edit the runServer task in the "build.gradle" file in the project's root directory.
